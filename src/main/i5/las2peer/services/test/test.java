...
public class test extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "test-microservice51", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "test", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/CAE-Community-Application-Editor/microservice-test-microservice51/blob/master/LICENSE.txt") ) )
  @Path("/")
